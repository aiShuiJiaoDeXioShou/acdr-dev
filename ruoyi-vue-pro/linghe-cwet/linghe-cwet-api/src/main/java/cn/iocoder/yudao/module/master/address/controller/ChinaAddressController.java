package cn.iocoder.yudao.module.master.address.controller;
...
import cn.iocoder.yudao.module.master.address.mapper.ChinaAddressMapper;
...
@Api(tags = "中国地址表")
@RestController
@RequestMapping("/pet/china-address")
public class ChinaAddressController {

    @Resource
    private ChinaAddressService service;
    ...
    public GlobalResponse<List<ChinaAddress>> my() {
        return GlobalResponse.success(
                service.lambdaQuery().eq(ChinaAddress::getUserId, LoginUtil.getLoginIdAsLong()).list()
        );
    }
