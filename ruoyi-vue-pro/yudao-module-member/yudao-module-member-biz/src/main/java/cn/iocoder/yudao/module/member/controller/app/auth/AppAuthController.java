...
public class AppAuthController {
    ...
    @Operation(summary = "系统注册账号")
    public CommonResult<AppAuthLoginRespVO> registered(@RequestBody @Valid AppAuthLoginReqVO reqVO) {
        return success(authService.registered(reqVO));
    }
