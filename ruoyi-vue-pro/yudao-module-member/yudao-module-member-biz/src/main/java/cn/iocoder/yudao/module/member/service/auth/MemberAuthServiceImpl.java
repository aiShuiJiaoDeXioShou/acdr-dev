...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    @Override
    @Transactional
    public AppAuthLoginRespVO registered(AppAuthLoginReqVO reqVO) {
        String userIp = getClientIP();
        // 获得获得注册用户
        MemberUserDO user = userService.createUserIfAbsent(reqVO.getMobile(), reqVO.getPassword(), userIp, getTerminal());
        Assert.notNull(user, "获取用户失败，结果为空");
